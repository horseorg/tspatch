 ...
 var topLevelDomain = "tspatch.com";
var domain = "www.tspatch.com";
var webimIframUrl = "http://tspatch.com/webim.html";
var uploadImageUrl = "http://tspatch/loadimage";
var jciUrl = "http://jci.tspatch.com";
var webimYUI = "1";
var webimV2 = "1";
...
if (hostArray.length == 5 && hostArray[2] == 'partner') {
    topLevelDomain = hostArray[1] + '.' + hostArray[2] + '.tspatch.com';
} else if (hostArray.length == 4 && hostArray[1] == 'partner') {
    topLevelDomain = hostArray[0] + '.' + hostArray[1] + '.tspatch.com';
}
...
function loadNyroModal()
{
 ...
 var XZWebUrlWriter = {
    ...
    getWebIm_RequestUserStateUrl : function (userid) {
        return 'http://'+domain+'/webim.php?op=getUserState&userid=' + userid;
    },
    ...
    getWebIm_CheckKeywordUrl : function (dataArr, type) {
        return 'http://greatwall.tspatch.com/greatwall.php?content=' + JSON.stringify(dataArr) + '&type=' + type + '&_t=' + new Date().getTime();
    },
    ...
    getAjax_CheckUsernameExist : function (username) {
        return 'http://'+domain+'/ajax.php?op=AJAX_CheckUsernameExist&username=' + username;
    },
    ...
    getAjax_CheckActiveCode : function (mobile,activateCode) {
        return 'http://'+domain+'/ajax.php?op=AJAX_CheckActivateCode&mobile='+mobile+'&activatecode='+activateCode;
    },
 ...
 var xzRegularExpression={a:1,isMobile:/^\d{11}$/,isUsername:/^[\w|\u4E00-\u9FA5]*$/,simpleMobile:/^\d{11}$/,mobile:/^1((3[0-9])|(4[57])|(5[0-35-9])|(7[6780])|(8[0-9]))\d{8}$/,password:/^[0-9a-zA-Z*!@.\-? : ;|$#%^&()_+=\[\]\\\/{}<>",~`']{0,}$/,numbers:/[1-9][0-9]{4}/,simpleEmail:/^.*?@.+$/,email:/^[a-zA-Z0-9_\.\-]+@[a-zA-Z0-9_\-]+(\.[a-zA-Z0-9_\-]+)+[a-zA-Z]+$/,passport:/^[\d\w]{4,20}$/}; 
 (function($) {
...
hotcitys[0]=new Array('bj','北京','beijing','bj','2140','beijing','北京','','',12);

hotcitys[1]=new Array('sh','上海','shanghai','sh','1216','shanghai','上海','','',13);

hotcitys[2]=new Array('gz','广州','guangzhou','gz','570','guangdong','广东','','',16);

hotcitys[3]=new Array('sz','深圳','shenzhen','sz','387','guangdong','广东','','',17);

hotcitys[4]=new Array('xa','西安','xian','xa','624','shanxi','陕西','','',176);

hotcitys[5]=new Array('zz','郑州','zhengzhou','zz','329','henan','河南','','',103);

hotcitys[6]=new Array('cd','成都','chengdu','cd','836','sichuan','四川','','',45);

hotcitys[7]=new Array('wh','武汉','wuhan','wh','319','hubei','湖北','','',194);

hotcitys[8]=new Array('nj','南京','nanjing','nj','325','jiangsu','江苏','','',65);

hotcitys[9]=new Array('cq','重庆','chongqing','cq','545','zhongqing','重庆','','',15);

hotcitys[10]=new Array('hz','杭州','hangzhou','hz','235','zhejiang','浙江','','',26);

hotcitys[11]=new Array('dl','大连','dalian','dl','520','liaoning','辽宁','','',56);

hotcitys[12]=new Array('qd','青岛','qingdao','qd','1445','shandong','山东','','',114);

hotcitys[13]=new Array('sz','苏州','suzhou','su','163','jiangsu','江苏','','',67);

hotcitys[14]=new Array('sy','三亚','sanya','sanya','926','hainan','海南','','',144);

hotcitys[15]=new Array('xm','厦门','xiamen','xm','312','fujian','福建','','',76);

hotcitys[16]=new Array('km','昆明','kunming','km','146','yunnan','云南','','',225);

hotcitys[17]=new Array('sy','沈阳','shenyang','sy','163','liaoning','辽宁','','',55);

hotcitys[18]=new Array('wx','无锡','wuxi','wx','91','jiangsu','江苏','','',66);

hotcitys[19]=new Array('xg','香港','xianggang','xianggang','219','xianggang','香港','','',344);

var citys=new Array();

citys[0]=new Array('ls','陵水','lingshui','lingshui','3','hainan','海南','','',410);

citys[1]=new Array('tz','台中','taizhong','tz','2','taiwan','台湾','','',380);

citys[2]=new Array('ld','乐东','ledong','ledong','1','hainan','海南','','',409);

citys[3]=new Array('xb','新北','xinbei','xb','1','taiwan','台湾','','',379);

citys[4]=new Array('qh','琼海','qionghai','qionghai','1','hainan','海南','','',399);

citys[5]=new Array('jy','嘉义','jiayi','jy','1','taiwan','台湾','','',385);

citys[6]=new Array('gx','高雄','gaoxiong','gx','4','taiwan','台湾','','',382);

citys[7]=new Array('wn','万宁','wanning','wanning','3','hainan','海南','','',401);

citys[8]=new Array('tb','台北','taibei','tb','1','taiwan','台湾','','',378);

citys[9]=new Array('bj','北京','beijing','bj','2140','beijing','北京','','',12);

citys[10]=new Array('sh','上海','shanghai','sh','1216','shanghai','上海','','',13);

citys[11]=new Array('gz','广州','guangzhou','gz','570','guangdong','广东','','',16);

citys[12]=new Array('sz','深圳','shenzhen','sz','387','guangdong','广东','','',17);

citys[13]=new Array('xa','西安','xian','xa','624','shanxi','陕西','','',176);

citys[14]=new Array('zz','郑州','zhengzhou','zz','329','henan','河南','','',103);

citys[15]=new Array('tj','天津','tianjin','tj','145','tianjin','天津','','',14);

citys[16]=new Array('cd','成都','chengdu','cd','836','sichuan','四川','','',45);

citys[17]=new Array('wh','武汉','wuhan','wh','319','hubei','湖北','','',194);

citys[18]=new Array('nj','南京','nanjing','nj','325','jiangsu','江苏','','',65);

citys[19]=new Array('cq','重庆','chongqing','cq','545','zhongqing','重庆','','',15);

citys[20]=new Array('hz','杭州','hangzhou','hz','235','zhejiang','浙江','','',26);

citys[21]=new Array('dl','大连','dalian','dl','520','liaoning','辽宁','','',56);

citys[22]=new Array('qd','青岛','qingdao','qd','1445','shandong','山东','','',114);

citys[23]=new Array('qhd','秦皇岛','qinhuangdao','qinhuangdao','481','hebei','河北','','',3);

citys[24]=new Array('sz','苏州','suzhou','su','163','jiangsu','江苏','','',67);

citys[25]=new Array('sy','三亚','sanya','sanya','926','hainan','海南','','',144);

citys[26]=new Array('xm','厦门','xiamen','xm','312','fujian','福建','','',76);

citys[27]=new Array('wh','威海','weihai','wei','221','shandong','山东','','',120);

citys[28]=new Array('km','昆明','kunming','km','146','yunnan','云南','','',225);

citys[29]=new Array('zh','珠海','zhuhai','zhuhai','70','guangdong','广东','','',18);

citys[30]=new Array('gl','桂林','guilin','gl','111','guangxi','广西','','',134);

citys[31]=new Array('ls','拉萨','lasa','ls','6','xicang','西藏','','',256);

citys[32]=new Array('bh','北海','beihai','beihai','104','guangxi','广西','','',317);

citys[33]=new Array('yt','烟台','yantai','yantai','175','shandong','山东','','',118);

citys[34]=new Array('lj','丽江','lijiang','lijiang','62','yunnan','云南','','',230);

citys[35]=new Array('sy','沈阳','shenyang','sy','163','liaoning','辽宁','','',55);

citys[36]=new Array('sjz','石家庄','shijiazhuang','sjz','145','hebei','河北','','',1);

citys[37]=new Array('heb','哈尔滨','haerbin','hrb','206','heilongjiang','黑龙江','','',93);

citys[38]=new Array('cs','长沙','changsha','cs','203','hunan','湖南','','',204);

citys[39]=new Array('cc','长春','changchun','cc','74','jilin','吉林','','',84);

citys[40]=new Array('hf','合肥','hefei','hf','99','anhui','安徽','','',123);

citys[41]=new Array('fz','福州','fuzhou','fz','55','fujian','福建','','',75);

citys[42]=new Array('nb','宁波','ningbo','nb','14','zhejiang','浙江','','',27);

citys[43]=new Array('wx','无锡','wuxi','wx','91','jiangsu','江苏','','',66);

citys[44]=new Array('hk','海口','haikou','hn','67','hainan','海南','','',143);

citys[45]=new Array('lz','兰州','lanzhou','lz','65','gansu','甘肃','','',166);

citys[46]=new Array('ly','洛阳','luoyang','luoyang','40','henan','河南','','',104);

citys[47]=new Array('wlmq','乌鲁木齐','wulumuqi','xj','22','xinjiang','新疆','','',241);

citys[48]=new Array('xz','徐州','xuzhou','xuzhou','11','jiangsu','江苏','','',68);

citys[49]=new Array('gy','贵阳','guiyang','gy','67','guizhou','贵州','','',36);

citys[50]=new Array('ty','太原','taiyuan','ty','56','shanxi','山西','','',155);

citys[51]=new Array('hhht','呼和浩特','huhehaote','nmg','35','neimenggu','内蒙古','','',145);

citys[52]=new Array('jn','济南','jinan','jn','211','shandong','山东','','',113);

citys[53]=new Array('ts','唐山','tangshan','tangshan','17','hebei','河北','','',2);

citys[54]=new Array('bd','保定','baoding','baoding','21','hebei','河北','','',6);

citys[55]=new Array('nc','南昌','nanchang','nc','27','jiangxi','江西','','',214);

citys[56]=new Array('hd','邯郸','handan','handan','4','hebei','河北','','',4);

citys[57]=new Array('nn','南宁','nanning','nn','19','guangxi','广西','','',142);

citys[58]=new Array('wf','潍坊','weifang','weifang','11','shandong','山东','','',119);

citys[59]=new Array('jz','锦州','jinzhou','jinzhou','1','liaoning','辽宁','','',60);

citys[60]=new Array('rz','日照','rizhao','rizhao','259','shandong','山东','','',306);

citys[61]=new Array('ly','临沂','linyi','linyi','14','shandong','山东','','',307);

citys[62]=new Array('as','鞍山','anshan','anshan','13','liaoning','辽宁','','',57);

citys[63]=new Array('lf','廊坊','langfang','langfang','4','hebei','河北','','',10);

citys[64]=new Array('dq','大庆','daqing','daqing','2','heilongjiang','黑龙江','','',98);

citys[65]=new Array('cz','常州','changzhou','changzhou','19','jiangsu','江苏','','',69);

citys[66]=new Array('zs','中山','zhongshan','zhongshan','22','guangdong','广东','','',25);

citys[67]=new Array('xn','西宁','xining','xn','69','qinghai','青海','','',186);

citys[68]=new Array('jh','金华','jinhua','jinhua','11','zhejiang','浙江','','',32);

citys[69]=new Array('dd','丹东','dandong','dandong','24','liaoning','辽宁','','',59);

citys[70]=new Array('cd','承德','chengde','chengde','107','hebei','河北','','',8);

citys[71]=new Array('pj','盘锦','panjin','panjin','15','liaoning','辽宁','','',63);

citys[72]=new Array('zb','淄博','zibo','zibo','5','shandong','山东','','',115);

citys[73]=new Array('zz','株洲','zhuzhou','zhuzhou','10','hunan','湖南','','',205);

citys[74]=new Array('fs','佛山','foshan','foshan','15','guangdong','广东','','',20);

citys[75]=new Array('jl','吉林','jilinshi','jilin','10','jilin','吉林','','',85);

citys[76]=new Array('xt','邢台','xingtai','xingtai','1','hebei','河北','','',5);

citys[77]=new Array('qqhe','齐齐哈尔','qiqihaer','qiqihaer','1','heilongjiang','黑龙江','','',94);

citys[78]=new Array('yc','宜昌','yichang','yichang','11','hubei','湖北','','',199);

citys[79]=new Array('dt','大同','datong','datong','46','shanxi','山西','','',156);

citys[80]=new Array('yz','扬州','yangzhou','yangzhou','31','jiangsu','江苏','','',74);

citys[81]=new Array('yc','银川','yinchuan','yc','21','ningxia','宁夏','','',165);

citys[82]=new Array('wz','温州','wenzhou','wenzhou','9','zhejiang','浙江','','',28);

citys[83]=new Array('ha','淮安','huaian','huaian','4','jiangsu','江苏','','',72);

citys[84]=new Array('my','绵阳','mianyang','mianyang','29','sichuan','四川','','',49);

citys[85]=new Array('bt','包头','baotou','baotou','9','neimenggu','内蒙古','','',146);

citys[86]=new Array('fs','抚顺','fushun','fushun','15','liaoning','辽宁','','',58);

citys[87]=new Array('ta','泰安','taian','taian','17','shandong','山东','','',305);

citys[88]=new Array('jn','济宁','jining','jining','8','shandong','山东','','',304);

citys[89]=new Array('lyg','连云港','lianyungang','lianyungang','5','jiangsu','江苏','','',71);

citys[90]=new Array('xg','香港','xianggang','xianggang','219','xianggang','香港','','',344);

citys[91]=new Array('qz','泉州','quanzhou','quanzhou','4','fujian','福建','','',79);

citys[92]=new Array('ay','安阳','anyang','anyang','10','henan','河南','','',109);

citys[93]=new Array('hz','惠州','huizhou','huizhou','36','guangdong','广东','','',23);

citys[94]=new Array('hld','葫芦岛','huludao','huludao','70','liaoning','辽宁','','',64);

citys[95]=new Array('jx','嘉兴','jiaxing','jiaxing','50','zhejiang','浙江','','',29);

citys[96]=new Array('nt','南通','nantong','nantong','8','jiangsu','江苏','','',70);

citys[97]=new Array('jms','佳木斯','jiamusi','jiamusi','10','heilongjiang','黑龙江','','',100);

citys[98]=new Array('dz','德州','dezhou','dezhou','1','shandong','山东','','',308);

citys[99]=new Array('gz','赣州','ganzhou','ganzhou','1','jiangxi','江西','','',220);

citys[100]=new Array('xy','咸阳','xianyang','xianyang','2','shanxi','陕西','','',179);

citys[101]=new Array('zz','漳州','zhangzhou','zhangzhou','10','fujian','福建','','',80);

citys[102]=new Array('xf','襄樊','xiangfan','xiangfan','1','hubei','湖北','','',196);

citys[103]=new Array('nc','南充','nanchong','nanchong','4','sichuan','四川','','',51);

citys[104]=new Array('lc','聊城','liaocheng','liaocheng','1','shandong','山东','','',309);

citys[105]=new Array('zjk','张家口','zhangjiakou','zhangjiakou','13','hebei','河北','','',7);

citys[106]=new Array('cz','沧州','cangzhou','cangzhou','1','hebei','河北','','',9);

citys[107]=new Array('shz','石河子','shihezi','shihezi','1','xinjiang','新疆','','',255);

citys[108]=new Array('bj','宝鸡','baoji','baoji','2','shanxi','陕西','','',178);

citys[109]=new Array('zj','湛江','zhanjiang','zhanjiang','2','guangdong','广东','','',264);

citys[110]=new Array('sq','商丘','shangqiu','shangqiu','3','henan','河南','','',297);

citys[111]=new Array('pds','平顶山','pingdingshan','pingdingshan','1','henan','河南','','',105);

citys[112]=new Array('jj','九江','jiujiang','jiujiang','7','jiangxi','江西','','',217);

citys[113]=new Array('yk','营口','yingkou','yingkou','123','liaoning','辽宁','','',61);

citys[114]=new Array('wh','芜湖','wuhu','wuhu','3','anhui','安徽','','',124);

citys[115]=new Array('hlbe','呼伦贝尔','hulunbeier','hulunbeier','40','neimenggu','内蒙古','','',151);

citys[116]=new Array('xt','湘潭','xiangtan','xiangtan','2','hunan','湖南','','',206);

citys[117]=new Array('qy','清远','qingyuan','qingyuan','8','guangdong','广东','','',270);

citys[118]=new Array('sn','遂宁','suining','suining','1','sichuan','四川','','',276);

citys[119]=new Array('tz','泰州','jstaizhou','jstaizhou','1','jiangsu','江苏','','',291);

citys[120]=new Array('lz','泸州','luzhou','luzhou','8','sichuan','四川','','',47);

citys[121]=new Array('zs','舟山','zhoushan','zhoushan','19','zhejiang','浙江','','',34);

citys[122]=new Array('zj','镇江','zhenjiang','zhenjiang','2','jiangsu','江苏','','',290);

citys[123]=new Array('kf','开封','kaifeng','kaifeng','7','henan','河南','','',293);

citys[124]=new Array('eeds','鄂尔多斯','eerduosi','eerduosi','1','neimenggu','内蒙古','','',150);

citys[125]=new Array('yb','延边','yanbian','yanbian','17','jilin','吉林','','',92);

citys[126]=new Array('sx','绍兴','shaoxing','shaoxing','7','zhejiang','浙江','','',31);

citys[127]=new Array('ny','南阳','nanyang','nanyang','1','henan','河南','','',111);

citys[128]=new Array('hz','菏泽','heze','heze','2','shandong','山东','','',338);

citys[129]=new Array('zy','遵义','zunyi','zunyi','6','guizhou','贵州','','',38);

citys[130]=new Array('xq','宿迁','suqian','suqian','1','jiangsu','江苏','','',292);

citys[131]=new Array('jz','焦作','jiaozuo','jiaozuo','6','henan','河南','','',106);

citys[132]=new Array('cz','长治','changzhi','changzhi','10','shanxi','山西','','',158);

citys[133]=new Array('hz','汉中','hanzhong','hanzhong','2','shanxi','陕西','','',182);

citys[134]=new Array('tl','铁岭','tieling','tieling','1','liaoning','辽宁','','',288);

citys[135]=new Array('jz','晋中','jinzhong','jinzhong','21','shanxi','山西','','',161);

citys[136]=new Array('ak','安康','ankang','ankang','1','shanxi','陕西','','',184);

citys[137]=new Array('yy','岳阳','yueyang','yueyang','1','hunan','湖南','','',209);

citys[138]=new Array('zq','肇庆','zhaoqing','zhaoqing','2','guangdong','广东','','',265);

citys[139]=new Array('hs','衡水','hengshui','hengshui','4','hebei','河北','','',11);

citys[140]=new Array('mdj','牡丹江','mudanjiang','mudanjiang','3','heilongjiang','黑龙江','','',302);

citys[141]=new Array('aq','安庆','anqing','anqing','1','anhui','安徽','','',127);

citys[142]=new Array('ls','乐山','leshan','leshan','20','sichuan','四川','','',50);

citys[143]=new Array('bb','蚌埠','bengbu','bengbu','2','anhui','安徽','','',125);

citys[144]=new Array('sg','韶关','shaoguan','shaoguan','7','guangdong','广东','','',263);

citys[145]=new Array('yj','阳江','yangjiang','yangjiang','2','guangdong','广东','','',269);

citys[146]=new Array('cz','潮州','chaozhou','chaozhou','2','guangdong','广东','','',271);

citys[147]=new Array('zjj','张家界','zhangjiajie','zhangjiajie','2','hunan','湖南','','',334);

citys[148]=new Array('xsbn','西双版纳','xishuangbanna','xishuangbanna','7','yunnan','云南','','',235);

citys[149]=new Array('sm','三明','sanming','sanming','1','fujian','福建','','',78);

citys[150]=new Array('yc','运城','yuncheng','yuncheng','1','shanxi','山西','','',162);

citys[151]=new Array('ms','眉山','meishan','meishan','1','sichuan','四川','','',279);

citys[152]=new Array('fcg','防城港','fangchenggang','fangchenggang','4','guangxi','广西','','',318);

citys[153]=new Array('sr','上饶','shangrao','shangrao','3','jiangxi','江西','','',224);

citys[154]=new Array('dl','大理','dali','dali','55','yunnan','云南','','',237);

citys[155]=new Array('qz','衢州','quzhou','quzhou','1','zhejiang','浙江','','',33);

citys[156]=new Array('bs','白山','baishan','baishan','5','jilin','吉林','','',89);

citys[157]=new Array('sz','池州','chizhou','chizhou','1','anhui','安徽','','',315);

citys[158]=new Array('hs','黄石','huangshi','huangshi','4','hubei','湖北','','',195);

citys[159]=new Array('xx','湘西','xiangxi','xiangxi','5','hunan','湖南','','',337);

citys[160]=new Array('ls','凉山','liangshan','liangshan','6','sichuan','四川','','',54);

citys[161]=new Array('yb','宜宾','yibin','yibin','6','sichuan','四川','','',52);

citys[162]=new Array('hz','湖州','huzhou','huzhou','19','zhejiang','浙江','','',30);

citys[163]=new Array('cz','滁州','chuzhou','chuzhou','1','anhui','安徽','','',128);

citys[164]=new Array('ya','延安','yanan','yanan','4','shanxi','陕西','','',181);

citys[165]=new Array('np','南平','nanping','nanping','1','fujian','福建','','',81);

citys[166]=new Array('sy','松原','songyuan','songyuan','4','jilin','吉林','','',90);

citys[167]=new Array('hs','黄山','huangshan','huangshan','15','anhui','安徽','','',313);

citys[168]=new Array('byne','巴彦淖尔','bayannaoer','bayannaoer','1','neimenggu','内蒙古','','',152);

citys[169]=new Array('wn','渭南','weinan','weinan','2','shanxi','陕西','','',180);

citys[170]=new Array('xn','咸宁','xianning','xianning','3','hubei','湖北','','',329);

citys[171]=new Array('es','恩施','enshi','enshi','5','hubei','湖北','','',331);

citys[172]=new Array('ly','龙岩','longyan','longyan','3','fujian','福建','','',82);

citys[173]=new Array('th','通化','tonghua','tonghua','5','jilin','吉林','','',88);

citys[174]=new Array('jdz','景德镇','jingdezhen','jingdezhen','1','jiangxi','江西','','',215);

citys[175]=new Array('hh','黑河','heihe','heihe','2','heilongjiang','黑龙江','','',101);

citys[176]=new Array('ll','吕梁','lvliang','lvliang','5','shanxi','山西','','',323);

citys[177]=new Array('yl','榆林','sxyulin','sxyulin','4','shanxi','陕西','','',183);

citys[178]=new Array('px','萍乡','pingxiang','pingxiang','2','jiangxi','江西','','',216);

citys[179]=new Array('hm','哈密','hami','hami','2','xinjiang','新疆','','',244);

citys[180]=new Array('ab','阿坝','aba','aba','7','sichuan','四川','','',283);

citys[181]=new Array('nd','宁德','ningde','ningde','5','fujian','福建','','',83);

citys[182]=new Array('als','阿拉善','alashan','alashan','7','neimenggu','内蒙古','','',322);

citys[183]=new Array('ks','喀什','kashi','kashi','1','xinjiang','新疆','','',247);

citys[184]=new Array('yc','伊春','hljyichun','hljyichun','9','heilongjiang','黑龙江','','',99);

citys[185]=new Array('aks','阿克苏','akesu','akesu','1','xinjiang','新疆','','',246);

citys[186]=new Array('ga','广安','guangan','guangan','1','sichuan','四川','','',278);

citys[187]=new Array('qdn','黔东南','qiandongnan','qiandongnan','3','guizhou','贵州','','',43);

citys[188]=new Array('zy','张掖','zhangye','zhangye','6','gansu','甘肃','','',171);

citys[189]=new Array('jq','酒泉','jiuquan','jiuquan','1','gansu','甘肃','','',173);

citys[190]=new Array('klmy','克拉玛依','kelamayi','kelamayi','1','xinjiang','新疆','','',242);

citys[191]=new Array('yl','伊犁','yili','yili','2','xinjiang','新疆','','',252);

citys[192]=new Array('ls','丽水','lishui','lishui','1','zhejiang','浙江','','',285);

citys[193]=new Array('wys','武夷山','wuyishan','wuyishan','1','fujian','福建','','',349);

citys[194]=new Array('tc','铜川','tongchuan','tongchuan','1','shanxi','陕西','','',177);

citys[195]=new Array('xz','忻州','xinzhou','xinzhou','4','shanxi','山西','','',163);

citys[196]=new Array('ww','武威','wuwei','wuwei','2','gansu','甘肃','','',170);

citys[197]=new Array('hx','海西','haixi','haixi','1','qinghai','青海','','',193);

citys[198]=new Array('hh','红河','honghe','honghe','1','yunnan','云南','','',234);

citys[199]=new Array('hb','海北','haibei','haibei','1','qinghai','青海','','',188);

citys[200]=new Array('dq','迪庆','diqing','diqing','1','yunnan','云南','','',240);

citys[201]=new Array('wc','文昌','wenchang','wc','4','hainan','海南','','',397);
...
$(window).load(function() {
    ...
    $('#commentdiary').load('/ajax.php?op=Ajax_getCommentDiary4Index', function(){
        ...
        for(var i=0;i<commentAndDiary.length;i++) {
            commentAndDiary[i].removeEventListener('touchstart');
            commentAndDiary[i].removeEventListener('touchend');
            commentAndDiary[i].addEventListener('touchstart',function(ev) {
                var touch = ev.touches[0];
                var changedTouches = ev.changedTouches;
                commentAndDiaryStartClientX = changedTouches[0].clientX;
            },false);
            commentAndDiary[i].addEventListener('touchend',function(ev) {
                var touch = ev.touches[0];
                var changedTouches = ev.changedTouches;
    ...
    for(var i=0;i<indeximage.length;i++) {
        indeximage[i].removeEventListener('touchstart');
        indeximage[i].removeEventListener('touchend');
        indeximage[i].addEventListener('touchstart',function(ev) {
            var touch = ev.touches[0];
            var changedTouches = ev.changedTouches;
            startClientX = changedTouches[0].clientX;
        },false);
        indeximage[i].addEventListener('touchend',function(ev) {
            var touch = ev.touches[0];
            var changedTouches = ev.changedTouches;
